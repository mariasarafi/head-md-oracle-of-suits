...
function draw() {
  ...
  //leftEyeBlink = getBlendshapeScore('jawOpen');

  // if the eye is open then put the background blue else put it red
  if (leftEyeBlink < 0.5) {
    background(0,0,255);
  } else {
    background(255, 0, 0);
...
if (isVideoReady()) {
  ...
  // draw the LeftEyeBlink in text under the video
  fill(255);
  //noStroke();
  textSize(32);
  textAlign(LEFT, TOP);
  text("leftEyeBlink: " + leftEyeBlink.toFixed(2), 10, height - 40);
